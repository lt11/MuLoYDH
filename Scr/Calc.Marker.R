...
# this one classifies marker in 4 categories:
# translocations, inversions, inter-/intrachromosomal
# and saves the corresponding tables
# it also calcualtes the fractions of sequence and structural divergence
# from filtered markers (so it runs after ClrS.R)
...
if (nInvInterChromTrans != 0) {
  # in dfGGFilt tutti i marker mappano sullo stesso cromosoma
...
for (indC in allChr) {
  # puoi pescare il cromosoma giusto sulla base di un solo reference, mitico!
